...
export async function updateIsPublished(id: string, isPublished: boolean, currentLibraryList: Ref<Library[]>, onDone: ()=>void) {
  try {
    const result = await axios.post('update-is-published', {id, isPublished});
