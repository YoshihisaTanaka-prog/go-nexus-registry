...
func (_u *GroupUpdate) SetIsForUser(v bool) *GroupUpdate {
	_u.mutation.SetIsForUser(v)
	return _u
}

// SetNillableIsForUser sets the "isForUser" field if the given value is not nil.
func (_u *GroupUpdate) SetNillableIsForUser(v *bool) *GroupUpdate {
	if v != nil {
		_u.SetIsForUser(*v)
	}
	return _u
...
func (_u *GroupUpdate) SetRequestedBy(v string) *GroupUpdate {
	_u.mutation.SetRequestedBy(v)
	return _u
}

// SetNillableRequestedBy sets the "requestedBy" field if the given value is not nil.
func (_u *GroupUpdate) SetNillableRequestedBy(v *string) *GroupUpdate {
	if v != nil {
		_u.SetRequestedBy(*v)
	}
	return _u
...
func (_u *GroupUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.IsForUser(); ok {
...
// SetIsForUser sets the "isForUser" field.
func (_u *GroupUpdateOne) SetIsForUser(v bool) *GroupUpdateOne {
	_u.mutation.SetIsForUser(v)
	return _u
}

// SetNillableIsForUser sets the "isForUser" field if the given value is not nil.
func (_u *GroupUpdateOne) SetNillableIsForUser(v *bool) *GroupUpdateOne {
	if v != nil {
		_u.SetIsForUser(*v)
	}
	return _u
...
// SetRequestedBy sets the "requestedBy" field.
func (_u *GroupUpdateOne) SetRequestedBy(v string) *GroupUpdateOne {
	_u.mutation.SetRequestedBy(v)
	return _u
}

// SetNillableRequestedBy sets the "requestedBy" field if the given value is not nil.
func (_u *GroupUpdateOne) SetNillableRequestedBy(v *string) *GroupUpdateOne {
	if v != nil {
		_u.SetRequestedBy(*v)
	}
	return _u
