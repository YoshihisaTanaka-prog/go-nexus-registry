...
// IsForUser applies equality check predicate on the "isForUser" field. It's identical to IsForUserEQ.
func IsForUser(v bool) predicate.Group {
	return predicate.Group(sql.FieldEQ(FieldIsForUser, v))
}

// RequestedBy applies equality check predicate on the "requestedBy" field. It's identical to RequestedByEQ.
func RequestedBy(v string) predicate.Group {
	return predicate.Group(sql.FieldEQ(FieldRequestedBy, v))
}
...
// IsForUserEQ applies the EQ predicate on the "isForUser" field.
func IsForUserEQ(v bool) predicate.Group {
	return predicate.Group(sql.FieldEQ(FieldIsForUser, v))
}

// IsForUserNEQ applies the NEQ predicate on the "isForUser" field.
func IsForUserNEQ(v bool) predicate.Group {
	return predicate.Group(sql.FieldNEQ(FieldIsForUser, v))
}

// RequestedByEQ applies the EQ predicate on the "requestedBy" field.
func RequestedByEQ(v string) predicate.Group {
	return predicate.Group(sql.FieldEQ(FieldRequestedBy, v))
}

// RequestedByNEQ applies the NEQ predicate on the "requestedBy" field.
func RequestedByNEQ(v string) predicate.Group {
	return predicate.Group(sql.FieldNEQ(FieldRequestedBy, v))
}

// RequestedByIn applies the In predicate on the "requestedBy" field.
func RequestedByIn(vs ...string) predicate.Group {
	return predicate.Group(sql.FieldIn(FieldRequestedBy, vs...))
}

// RequestedByNotIn applies the NotIn predicate on the "requestedBy" field.
func RequestedByNotIn(vs ...string) predicate.Group {
	return predicate.Group(sql.FieldNotIn(FieldRequestedBy, vs...))
}

// RequestedByGT applies the GT predicate on the "requestedBy" field.
func RequestedByGT(v string) predicate.Group {
	return predicate.Group(sql.FieldGT(FieldRequestedBy, v))
}

// RequestedByGTE applies the GTE predicate on the "requestedBy" field.
func RequestedByGTE(v string) predicate.Group {
	return predicate.Group(sql.FieldGTE(FieldRequestedBy, v))
}

// RequestedByLT applies the LT predicate on the "requestedBy" field.
func RequestedByLT(v string) predicate.Group {
	return predicate.Group(sql.FieldLT(FieldRequestedBy, v))
}

// RequestedByLTE applies the LTE predicate on the "requestedBy" field.
func RequestedByLTE(v string) predicate.Group {
	return predicate.Group(sql.FieldLTE(FieldRequestedBy, v))
}

// RequestedByContains applies the Contains predicate on the "requestedBy" field.
func RequestedByContains(v string) predicate.Group {
	return predicate.Group(sql.FieldContains(FieldRequestedBy, v))
}

// RequestedByHasPrefix applies the HasPrefix predicate on the "requestedBy" field.
func RequestedByHasPrefix(v string) predicate.Group {
	return predicate.Group(sql.FieldHasPrefix(FieldRequestedBy, v))
}

// RequestedByHasSuffix applies the HasSuffix predicate on the "requestedBy" field.
func RequestedByHasSuffix(v string) predicate.Group {
	return predicate.Group(sql.FieldHasSuffix(FieldRequestedBy, v))
}

// RequestedByEqualFold applies the EqualFold predicate on the "requestedBy" field.
func RequestedByEqualFold(v string) predicate.Group {
	return predicate.Group(sql.FieldEqualFold(FieldRequestedBy, v))
}

// RequestedByContainsFold applies the ContainsFold predicate on the "requestedBy" field.
func RequestedByContainsFold(v string) predicate.Group {
	return predicate.Group(sql.FieldContainsFold(FieldRequestedBy, v))
}
